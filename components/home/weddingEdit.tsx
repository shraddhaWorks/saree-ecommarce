...
const collections = [
    { title: "Haldi & Mehendi Edit", img: "/Haldi_Mehendi_Edit.webp" },
    { title: "Sangeet Evening Wardrobe", img: "/Sangeet_Evening_Wardrobe.webp" },
    { title: "Reception Couture", img: "/Reception_Couture.webp" },
    { title: "Bridesmaid Wardrobe", img: "/Bridesmaid_Wardrobe.webp" },
];
                    ...
                    return (
                        <Link key={index} href={`/collections/${handle}`} className="group cursor-pointer">
                            <div className="relative overflow-hidden rounded-xl bg-surface">
                                ...
                                {/* TITLE */}
                                <h3 className="absolute left-5 bottom-8 text-white text-lg md:text-xl font-semibold leading-tight max-w-[70%] break-words transition-all duration-300 group-hover:bottom-12">
                                    {item.title}
                                </h3>
