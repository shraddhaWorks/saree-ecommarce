      ...
      <div className="mx-auto max-w-7xl px-6 py-32">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="mt-8 space-y-6 text-lg text-black/70">
              ...
              <div className="space-y-4 rounded-3xl bg-white p-8 shadow-sm">
                <p className="flex items-center gap-3">
                  <span className="font-semibold text-black">Address:</span> M.G. Road, Vijayawada, Andhra Pradesh
                </p>
                <p className="flex items-center gap-3">
                  <span className="font-semibold text-black">Phone:</span> +91 866 123 4567
                </p>
                <p className="flex items-center gap-3">
          ...
          <div className="overflow-hidden rounded-[32px] bg-[#f3ebe0]">
            <img 
              src="https://images.unsplash.com/photo-1590487988256-9ed24133863e?auto=format&fit=crop&q=80&w=1202" 
              alt="Vijayawada Store"
