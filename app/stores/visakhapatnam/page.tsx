        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 space-y-6 text-lg text-black/70">
              <p>
                Our Vizag boutique brings the finest coastal drapes and Andhra weaves to life in a stunning seaside setting.
              </p>
              <div className="space-y-4 rounded-3xl bg-white p-8 shadow-sm">
                <p className="flex items-center gap-3">
                  <span className="font-semibold text-black">Address:</span> Dwaraka Nagar, Visakhapatnam
                </p>
                <p className="flex items-center gap-3">
                  <span className="font-semibold text-black">Phone:</span> +91 891 123 4567
                </p>
                <p className="flex items-center gap-3">
          ...
          <div className="overflow-hidden rounded-[32px] bg-[#f3ebe0]">
            <img 
              src="https://images.unsplash.com/photo-1590487988256-9ed24133863e?auto=format&fit=crop&q=80&w=1203" 
              alt="Visakhapatnam Store"
